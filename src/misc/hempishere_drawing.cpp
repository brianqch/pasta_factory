...
HemisphereMesh::HemisphereMesh(int num_lat, int num_lon)
...
int HemisphereMesh::s_index(int x, int y) {
  return ((x) * (sphere_num_lon + 1) + (y));
}

void HemisphereMesh::build_data() {
...
void HemisphereMesh::draw_sphere(GLShader &shader, const Vector3D &p, double r) {
